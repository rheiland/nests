...
PhysiCell_custom_module_OBJECTS := custom_nests.o
...
all: main_nests.cpp $(ALL_OBJECTS)
	$(COMPILE_COMMAND) -o $(PROGRAM_NAME) $(ALL_OBJECTS) main_nests.cpp 
...
custom_nests.o: ./custom_modules/custom_nests.cpp 
	$(COMPILE_COMMAND) -c ./custom_modules/custom_nests.cpp
